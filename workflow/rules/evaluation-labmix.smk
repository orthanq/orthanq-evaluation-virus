rule scatter_plot:
    ...
    output:
        ...
        orthanq_html=report("results/evaluation-hiv/plots/orthanq/scatter_plot.html", category="5-virus-mix scatterplots", labels={
            "name": "orthanq",
            "type": "html"
        }),
        kallisto_svg="results/evaluation-hiv/plots/kallisto/scatter_plot.svg",
        kallisto_html=report("results/evaluation-hiv/plots/kallisto/scatter_plot.html", category="5-virus-mix scatterplots", labels={
            "name": "kallisto",
            "type": "html"
        })
    log:
